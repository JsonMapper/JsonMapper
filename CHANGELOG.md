...
## [Unreleased]
### Fixed
- Fix constructor not being called on nested array of objects [PR#162](https://github.com/JsonMapper/JsonMapper/pull/163). Thanks to [o15a3d4l11s2](https://github.com/o15a3d4l11s2) for reporting the issue.
